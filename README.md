 ...
 **注意：**  大部分人都是直接购买的 SS 帐号，这种帐号 90% 都只支持TCP浏览网页，不支持 **UDP转发**  ，问清楚你购买帐号的服务商，如果你的服务器不支持UDP转发，你不用往下看了，这个项目不适合你。TCP只能浏览网页，不能打网游，不能做任何基于UDP的服务（**不能做VPN**），你就安安静静的上上网页就好了，别的就不折腾了。
